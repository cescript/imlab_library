...
// GLOBAL DEFINITIONS //
static const float RGB2SEPIA[3][4] = { {0.393f, 0.769f, 0.189f, 0.0f}, {0.349f, 0.686f, 0.168f, 0.0f}, {0.272f, 0.534f, 0.131f, 0.0f} };
static const float RGB2YIQ  [3][4] = { {0.299f, 0.587f, 0.114f, 0.0f}, {0.596f, -0.275f, -0.321f, 128.0f}, {0.212f, -0.523f, 0.311f, 128.0f} };
static const float YIQ2RGB  [3][4] = { {1.0f, 0.956f, 0.621f, -201.856}, {1.0f, -0.272f, -0.647f, 117.632f}, {1.0f, -1.107f, 1.704f, -76.416f} };
static const float RGB2YCC  [3][4] = { {0.299f, 0.587f, 0.114f, 0.0f}, {0.5f, -0.419f, -0.081f, 128.0f}, {-0.169f, -0.331f, 0.5f, 128.0f} };
static const float YCC2RGB  [3][4] = { {1.0f, 1.402f, 0.0, -179.456f}, {1.0f, -0.714f, -0.344f, 135.424f}, {1.0f, 0.0f, 1.772f, -226.816f} };
